    ...
    return (
        <>
            <header className="App-header p-5 text-xs md:text-base lg:text-lg">
                <nav className='flex justify-between items-center mx-2 md:mx-10 lg:mx-20 cursor-pointer '>
                ...
                <div className='min-w-[300px] flex justify-evenly items-center gap-2'>
                    ...
                    <NavLink to={'/contactme'} >
                        <div className='hover:bg-black transition-all ease-in px-5 py-2 rounded border border-white'>Contact Me</div>
                    </NavLink>
                </div>
                </nav>
            </header>
